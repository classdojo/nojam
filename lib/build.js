  ...
  module.exports = (function() {
    ...
    */
    ...
    _Class.prototype._rebuildDir = function(dir, callback) {
      var deps, fdir, nodeModulesDir, pkg, pkgPath, self, _ref, _ref1;

      fdir = dir;
      pkgPath = fdir + "/package.json";
      nodeModulesDir = fdir + "/node_modules";
      pkg = require(pkgPath);
      deps = (_ref = (_ref1 = pkg.nojam) != null ? _ref1.dependencies : void 0) != null ? _ref : pkg.dependencies;
      if (!deps) {
        return callback();
      }
      self = this;
      deps = Object.keys(deps).filter(function(dep) {
