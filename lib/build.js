  ...
  module.exports = (function() {
    ...
    */
    ...
    _Class.prototype._rebuildDir = function(dir, callback) {
      var fdir, nodeModulesDir, pkg, pkgPath, self;
      ...
      self = this;
      return stepc.async((function() {
        if (fs.existsSync(nodeModulesDir) || !Object.keys(pkg.dependencies).length) {
          return this();
        }
        ...
        return async.eachSeries(Object.keys(pkg.dependencies), (function(dir, next) {
          var fp;

          if (/\.bin|\.DS_Store/.test(dir)) {
            return next();
          }
          if (fs.existsSync(self._output + "/" + dir)) {
            return next();
          }
