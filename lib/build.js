  ...
  module.exports = (function() {
    ...
    */
    function _Class(ops, packageManagers) {
      ...
      this._usedDeps = fs.readdirSync(this._output).map(function(dir) {
        var e;

        try {
          return require.resolve(_this._output + "/" + dir).replace(_this._output + "/", "");
        } catch (_error) {
          e = _error;
          return void 0;
        }
    ...
    */
    ...
    _Class.prototype._rebuildDir = function(dir, callback) {
      var deps, fdir, nodeModulesDir, pkg, pkgPath, self, _ref, _ref1, _ref2;
